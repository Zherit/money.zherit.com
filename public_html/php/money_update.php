<?php
	...
	if (!empty($_POST)) {
		if ($_POST['money']) {
			...
			$query_params = array(':money' => $_POST['money'], ':id' => $_SESSION['user']['id']);
		...
		if($_POST['credit']) {
			...
			$query_params = array(':credit' => $_POST['credit'], ':id' => $_SESSION['user']['id']);
		...
		if($_POST['link']) {
			...
			$query_params = array(':link' => '1', ':id' => $_SESSION['user']['id']);
			...
			$query = "UPDATE money SET link = :link WHERE id = :id";
			$query_params = array(':link' => '0', ':id' => $_SESSION['user']['id']);
		...
		if($_POST['use_cred']) {
			...
			$query_params = array(':use_cred' => '1', ':id' => $_SESSION['user']['id']);
			...
			$query = "UPDATE money SET use_cred = :use_cred WHERE id = :id";
			$query_params = array(':use_cred' => '0', ':id' => $_SESSION['user']['id']);
		...
		if($_POST['tax']) {
			...
			$query_params = array(':tax' => $tax, ':id' => $_SESSION['user']['id']);
		...
		if(!$_POST['recurs']) {
			...
			$query_params = array(':recurs' => '0', ':id' => $_SESSION['user']['id']);
			...
			$query = "UPDATE money SET recurs = :recurs WHERE id = :id";
			$query_params = array(':recurs' => '1', ':id' => $_SESSION['user']['id']);
		...
		if($_POST['month_def']) {
			...
			$query_params = array(':month_def' => $_POST['month_def'], ':id' => $_SESSION['user']['id']);
		...
		if($_POST['week_def']) {
			...
			$query_params = array(':week_def' => $_POST['week_def'], ':id' => $_SESSION['user']['id']);
		...
		if($_POST['day_def']) {
			...
			$query_params = array(':day_def' => $_POST['day_def'], ':id' => $_SESSION['user']['id']);
		...
		if($_POST['warning_week']) {
			...
			$query_params = array(':warning_week' => $_POST['warning_week'], ':id' => $_SESSION['user']['id']);
		...
		if($_POST['warning_month']) {
			...
			$query_params = array(':warning_month' => $_POST['warning_month'], ':id' => $_SESSION['user']['id']);
